# Generated by Django 4.0.3 on 2022-07-22 16:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='productopersonalizado',
            name='marca_ID',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api_rest.marca'),
        ),
        migrations.AddField(
            model_name='productopersonalizado',
            name='modelo_ID',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api_rest.modelo'),
        ),
        migrations.AddField(
            model_name='productopersonalizado',
            name='precio',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api_rest.tipo_producto'),
        ),
        migrations.AddField(
            model_name='producto',
            name='dispositivo_ID',
        ...
        migrations.AddField(
            model_name='producto',
            name='evento_ID',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api_rest.evento'),
        ),
        migrations.AddField(
            model_name='producto',
            name='marca_ID',
